...
struct InstructionSpecification<Mnemonic::STW> {
    static constexpr auto layout = ^^DForm::Impl_RS_RA_D;
    static constexpr auto zeroable_field = ^^DForm::RA;
...
struct InstructionSpecification<Mnemonic::LWZ> {
    static constexpr auto layout = ^^DForm::Impl_RT_RA_D;
    static constexpr auto zeroable_field = ^^DForm::RA;
...
struct InstructionSpecification<Mnemonic::BCLR> {
    static constexpr auto layout = ^^XLForm::Impl_BO_BI_BH_XO_LK;
...
struct InstructionSpecification<Mnemonic::ADD> {
    static constexpr auto layout = ^^XOForm::Impl_RT_RA_RB_OE_XO_Rc;
...
struct InstructionSpecification<Mnemonic::ANDI_RC> {
    static constexpr auto layout = ^^DForm::Impl_RS_RA_UI;
...
struct InstructionSpecification<Mnemonic::XOR> {
    static constexpr auto layout = ^^XForm::Impl_RS_RA_RB_XO_Rc;
    static constexpr u8 opcd = 31;
...
struct InstructionSpecification<Mnemonic::RLWINM> {
    static constexpr auto layout = ^^MForm::Impl_RS_RA_SH_MB_ME_Rc;
...
struct InstructionSpecification<Mnemonic::ADDI> {
    static constexpr auto layout = ^^DForm::Impl_RT_RA_SI;
    static constexpr auto zeroable_field = ^^DForm::RA;
...
struct InstructionSpecification<Mnemonic::CMPI> {
    static constexpr auto layout = ^^DForm::Impl_BF_L_RA_SI;
    static constexpr u8 opcd = 11;
    static constexpr std::array constants{//
        FieldConstant{^^DForm::L, 0}};
    static constexpr std::array accesses{//
...
struct InstructionSpecification<Mnemonic::MTSPR> {
    static constexpr auto layout = ^^XFXForm::Impl_RS_SPR_XO;
    static constexpr u8 opcd = 31;
...
struct InstructionSpecification<Mnemonic::MFSPR> {
    static constexpr auto layout = ^^XFXForm::Impl_RT_SPR_XO;
    static constexpr u8 opcd = 31;
    static constexpr u16 xo = 339;
    static constexpr std::array accesses{//
        FieldAccess{^^XFXForm::RT, Operand::Access::Write},
        FieldAccess{^^XFXForm::SPR, Operand::Access::Read}};
};
...
struct InstructionSpecification<Mnemonic::STWU> {
    ...
    static constexpr std::array accesses{//
        FieldAccess{^^DForm::RS, Operand::Access::Read},
        FieldAccess{^^DForm::RA, Operand::Access::ReadWrite}};
};
...
struct InstructionSpecification<Mnemonic::CRXOR> {
    static constexpr auto layout = ^^XLForm::Impl_BT_BA_BB_XO;
    static constexpr u8 opcd = 19;
...
struct InstructionSpecification<Mnemonic::CNTLZW> {
    static constexpr auto layout = ^^XForm::Impl_RS_RA_XO_Rc;
    static constexpr u8 opcd = 31;
