...
struct DForm {
    ...
    using FRT = Instruction::Field<6,  10, u8,  Operand::Type::FPR>;
    using FRS = Instruction::Field<6,  10, u8,  Operand::Type::FPR>;
...
struct XForm {
    ...
    using FRT   = Instruction::Field<6,  10, u8,  Operand::Type::FPR>;
    using FRS   = Instruction::Field<6,  10, u8,  Operand::Type::FPR>;
    using BT    = Instruction::Field<6,  10, u8,  Operand::Type::CR>;
    using BF    = Instruction::Field<6,  8,  u8,  Operand::Type::CR>;
    using TH    = Instruction::Field<7,  10, u8,  Operand::Type::Immediate>;
    using L10   = Instruction::Field<10, 10, u8,  Operand::Type::Immediate>;
    using RA    = Instruction::Field<11, 15, u8,  Operand::Type::GPR>;
    using FRA   = Instruction::Field<11, 15, u8,  Operand::Type::FPR>;
    using SR    = Instruction::Field<12, 15, u8,  Operand::Type::Immediate>;
    using BFA   = Instruction::Field<11, 13, u8,  Operand::Type::CR>;
    using L15   = Instruction::Field<15, 15, u8,  Operand::Type::Immediate>;
    ...
    using FRB   = Instruction::Field<16, 20, u8,  Operand::Type::FPR>;
    using U     = Instruction::Field<16, 19, u8,  Operand::Type::Immediate>;
    ...
    using Impl_RS_L15_XO         = Instruction::Layout<OPCD, RS, L15, XO>;
    ...
    using Impl_L10_RA_RB_XO      = Instruction::Layout<OPCD, L10, RA, RB, XO>;
    using Impl_L10_RB_XO         = Instruction::Layout<OPCD, L10, RB, XO>;
    using Impl_L10_XO            = Instruction::Layout<OPCD, L10, XO>;
...
struct XFLForm {
    using FLM = Instruction::Field<7,  14, u8,  Operand::Type::Immediate>;
    using FRB = Instruction::Field<16, 20, u8,  Operand::Type::FPR>;
    using XO  = Instruction::Field<21, 30, u16>;
    using Rc  = Instruction::Field<31, 31, u8>;
...
struct XSForm {
    using RS   = Instruction::Field<6,  10, u8,  Operand::Type::GPR>;
    using RA   = Instruction::Field<11, 15, u8,  Operand::Type::GPR>;
    using SH16 = Instruction::Field<16, 20, u8,  Operand::Type::Immediate>;
    using XO   = Instruction::Field<21, 29, u16>;
    using SH30 = Instruction::Field<30, 30, u8,  Operand::Type::Immediate>;
    using Rc   = Instruction::Field<31, 31, u8>;

    using Impl_RS_RA_SH16_XO_SH30_Rc = Instruction::Layout<OPCD, RS, RA, SH16, XO, SH30, Rc>;
};
...
struct AForm {
    ...
    using FRA = Instruction::Field<11, 15, u8, Operand::Type::FPR>;
    using FRB = Instruction::Field<16, 20, u8, Operand::Type::FPR>;
    using FRC = Instruction::Field<21, 25, u8, Operand::Type::FPR>;
...
struct MDForm {
    ...
    using RA   = Instruction::Field<11, 15, u8, Operand::Type::GPR>;
    using SH16 = Instruction::Field<16, 20, u8, Operand::Type::Immediate>;
    using MB   = Instruction::Field<21, 26, u8, Operand::Type::Immediate>;
    using ME   = Instruction::Field<21, 26, u8, Operand::Type::Immediate>;
    using XO   = Instruction::Field<27, 29, u8>;
    using SH30 = Instruction::Field<30, 30, u8, Operand::Type::Immediate>;
    using Rc   = Instruction::Field<31, 31, u8>;

    using Impl_RS_RA_SH16_MB_XO_SH30_Rc = Instruction::Layout<OPCD, RS, RA, SH16, MB, XO, SH30, Rc>;
    using Impl_RS_RA_SH16_ME_XO_SH30_Rc = Instruction::Layout<OPCD, RS, RA, SH16, ME, XO, SH30, Rc>;
};
